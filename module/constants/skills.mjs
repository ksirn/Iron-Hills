...
export const SKILL_GROUPS = [
  ...
  },
  {
    ...
    label: "Магия",
    skills: [
      { key:"fire",        label:"Огонь",              desc:"Пламя, жар, взрывы и горение" },
      { key:"ice",         label:"Лёд",                desc:"Холод, заморозка, хрупкость и контроль движения" },
      { key:"lightning",   label:"Молния",             desc:"Разряды, цепи, оглушение и скорость" },
      { key:"shadow",      label:"Тьма",               desc:"Проклятия, истощение, страх и некротика" },
      { key:"light",       label:"Свет",               desc:"Исцеление, очищение, защита и святое воздействие" },
      { key:"earth",       label:"Земля",              desc:"Камень, металл, броня и физическая устойчивость" },
      { key:"mind",        label:"Разум",              desc:"Иллюзии, контроль, воля и телепатия" },
      { key:"summon",      label:"Призыв",             desc:"Сущности, духи, временные союзники и магические создания" },
    ]
  }
];
